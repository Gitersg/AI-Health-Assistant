...
<style>
    ...
    /* Help resources / Contacts styling */
    .contact-item {
...
with st.sidebar:
    ...
    if os.path.exists(logo_path):
        ...
        st.markdown("<h2 style='text-align: center; color: #06b6d4;'>🩺 AI Health Assistant</h2>", unsafe_allow_html=True)
    ...
    if api_key_env:
        ...
        api_key_input = st.text_input("Enter Gemini API Key:", type="password", help="Get your API key from Google AI Studio")
        api_key = api_key_input
        if not api_key:
            st.warning("Please provide a Gemini API Key to start chatting.")
    ...
    <div class="glass-card disclaimer-card">
        <h4 style="color: #ef4444; margin-top: 0;">⚠️ Strict Medical Disclaimer</h4>
    ...
    <div class="glass-card emergency-card">
        <h4 style="color: #ef4444; margin-top: 0; display: flex; align-items: center; gap: 5px;">🚨 Emergency Contacts (India)</h4>
